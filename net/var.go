...
var UserAgentRandom string

func init() {
	runtime.GOMAXPROCS(-1)
	UserAgentRandom = UserAgents[W.RandomNum(0, len(UserAgents))]
}

type (
	KeyValueIpInfo struct {
		Key   string
		Value IpInfo
	}
	IpInfo struct {
		...
		LastCheckTimeStamp   time.Duration `json:"last_check_time_stamp"`
		LastSuccessTimeStamp time.Duration `json:"last_success_time_stamp"`
...
const (
	...
	Socks5                = "socks5"
	Socks                 = "socks"
	EaMobile              = "http://cdn.skum.eamobile.com"
	Google                = "https://www.google.com"
	MM20Init              = `https://mm20.prod.fuel.ddns.ea.com/g/game/content/init`
	Facebook              = "https://www.facebook.com"
	MAXGoRoutinesPoolSize = 1000
)
